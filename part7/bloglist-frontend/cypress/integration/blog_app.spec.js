  ...
  describe('when logged in', function () {
    ...
    describe('when there are blogs in the app', function () {
      ...
      it('A blog can be liked', function () {
        cy.contains('my first blog').as('firstBlog').contains('show').click()
        cy.get('@firstBlog').contains('likes 0')
      ...
      it('blogs are sorted by amount of likes, top blog on top', function () {
        ...
        cy.contains('third blog').contains('likes 0')
        cy.contains('third blog').contains('like').click()
        cy.contains('third blog').contains('like').click()
        cy.contains('second cool blog').contains('show').click()
        cy.contains('second cool blog').contains('like').click()
